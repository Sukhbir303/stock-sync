...
const printReceipt = (receipt) => {
  ...
  const htmlContent = `
    <html>
      <head>
        <title>Receipt - ${receipt.documentNumber || 'Draft'}</title>
        <style>
          ...
          .meta-box h3 { margin: 0 0 10px; font-size: 14px; text-transform: uppercase; color: #666; }
          .meta-box p { margin: 0; font-weight: bold; font-size: 16px; }
          ...
          .status-stamp { 
            ...
            border: 3px solid ${receipt.status === 'VALIDATED' ? '#10b981' : '#f59e0b'}; 
            color: ${receipt.status === 'VALIDATED' ? '#10b981' : '#f59e0b'}; 
            padding: 10px 20px; font-weight: bold; text-transform: uppercase; transform: rotate(-15deg); opacity: 0.5; 
          }
        </style>
      </head>
      <body>
        <div class="status-stamp">${receipt.status}</div>
        <div class="header">
          <h1>GOODS RECEIPT NOTE</h1>
          <p>Document #: ${receipt.documentNumber || 'PENDING'}</p>
        </div>

        <div class="meta-grid">
          <div class="meta-box">
            <h3>Supplier / Contact</h3>
            <p>${receipt.supplierName || receipt.contactName || 'N/A'}</p>
          </div>
          <div class="meta-box">
            <h3>Date</h3>
            <p>${format(new Date(receipt.createdAt), 'PPP')}</p>
          </div>
          <div class="meta-box">
            <h3>Destination</h3>
            <p>${receipt.destinationLocation}</p>
          </div>
          <div class="meta-box">
            <h3>Reference</h3>
        ...
        <div class="footer">
          <div>
            <p>Generated by StockMaster IMS</p>
...
// List View Component
const ReceiptsList = ({ rows, onValidate, onCancel, onDownload }) => {
  return (
                ...
                <tr key={index} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-center">
                    <div className="flex justify-center gap-2">
                      {/* Download Button - Always visible or only for validated? Always is useful for drafts too. */}
                      <button
